...
const char* ei_classifier_inferencing_categories[] = { "jasper", "noise", "unknown" };
...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 4
        4,
        1600, // output size
        &extract_audio_syntiant_features, // DSP function pointer
...
const uint32_t ei_learning_block_3_inputs[1] = { 4 };
...
const ei_impulse_t impulse_594229_0 = {
    .project_id = 594229,
    .project_owner = "Jasper Schröder",
    .project_name = "jazeph-project-1",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_594229_0 = ei_impulse_handle_t( &impulse_594229_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_594229_0;
